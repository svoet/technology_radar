...
- Molecular Simulation: Designing new drugs or materials by simulating molecular behavior.
- Optimization: Solving complex logistics and supply chain problems.
- Cryptography: Developing new, more secure encryption methods, while also posing risks to current encryption standards